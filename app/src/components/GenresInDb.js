        ...
        <div className="card-body">
          <div className="row">
            ...
            <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow">
                <img className="img" src={foto} alt="Trekking" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <img className="img" src={kayac} alt="Kayac" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={paracaidismo} alt="Paracaidismo" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={parapente} alt="Parapente" width="225" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={rappel} alt="rappel" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={cabalgata} alt="Cabalgata" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={ciclismo} alt="Ciclismo" width="219" height="200"/>
            ...
            <div className="col-lg-6 mb-4">
              <div className="card bg-dark text-white shadow">
                ...
                <div className="card bg-dark text-white shadow"></div>
                <img className="img" src={espeleismo} alt="Espeleismo" width="219" height="200"/>
